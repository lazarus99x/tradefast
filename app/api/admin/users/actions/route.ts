...
function getAdminClient() {
  ...
  // Use anon key first (RLS is disabled on all tables), fall back to service_role
  const key = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || process.env.SUPABASE_SERVICE_ROLE_KEY as string;
